# Реквизиты компаний ![icon](https://github.com/Sowa1980/Company_Rekvizit_preset/blob/master/Rekvizit-min.png) 
Набор заготовок для [JOSM](https://josm.openstreetmap.de/), служит для указания реквизитов организации ИНН, ОГРН, КПП, ОКПО, ОКОГУ, ОКОПФ
